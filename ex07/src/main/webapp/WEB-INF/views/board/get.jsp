...
$(document).ready(function(){
	...
	modalModBtn.on("click", function(e){
		var originalReply = modalInputReplyer.val();
		
		var reply = {
				rno: modal.data("rno"),
				reply: modalInputReply.val(),
				replyer: originalReply
		};
	...
	modalRemoveBtn.on("click", function(e){
		...
		replyService.remove(rno, originalReply, function(result){
			alert(result);
			modal.modal("hide");
			showList(pageNum);
		});
